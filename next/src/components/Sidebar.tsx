      ...
      <div className='leftWrapper | h-full'>
        <nav className="sideBar | max-sm:p-1  p-[1.125rem] border border-[#8C8C8C] rounded-[0.5rem] h-[96vh] flex flex-col justify-between sticky top-4 md:w-[248px] has-[:checked]:w-auto">
          <div>
            ...
            <Link href={`${user?roleRoute[user.userType]+"/classrooms":"/"}`} className='p-[0.625rem] rounded-[0.3125rem] hover:bg-[#ECECEc] mb-3 flex gap-3 items-center cursor-pointer'>
            ...
            (<Link href={`${user?roleRoute[user.userType]+"/dashboard":"/"}`} className='p-[0.625rem] rounded-[0.3125rem] hover:bg-[#ECECEc] flex gap-3 items-center cursor-pointer'>
            ...
            :
            (<Link href={`${user?roleRoute[user.userType]+"/calender":"/"}`} className='p-[0.625rem] rounded-[0.3125rem] hover:bg-[#ECECEc] flex gap-3 items-center cursor-pointer'>
              <img src="/sidebarCalendar.svg" alt="" className="w-[min(100%,26px)]"/>
              {sidebarActive && (
