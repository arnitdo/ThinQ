...
import Accordion from "../../../../quiz/[quizId]/Accordion";
import {
  BarChart,
  Bar,
  ResponsiveContainer,
...
const COLORS = ['#0088FE', '#00C49F']; // Define custom colors for the pie chart
              ...
              <PieChart>
                ...
                >
                  {attendance.map((entry, index) => (
                    <Cell
                      key={`cell-${index}`}
                      fill={COLORS[index % COLORS.length]} // Apply custom colors
                    />
                  ))}
                </Pie>
                <Tooltip />
