    ...
    <>
      <div className="flex justify-between items-end border-b pb-2">
        ...
        <Link href="/student/classrooms"
					...
					<Link href="/student/doubts" className="relative text-black | after:content-[''] after:absolute after:-bottom-4 after:left-0 after:w-full after:h-1 after:rounded-full after:bg-[#0A349E]">Doubts</Link>
        </nav>
        <button
